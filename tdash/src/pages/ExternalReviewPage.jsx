...
const ExternalReviewLoadingSkeleton = () => (
            ...
            <div className="mx-auto max-w-[1500px] space-y-5 px-4 py-6 sm:px-6 lg:px-8">
                <section className={`${panelClass} overflow-hidden px-6 py-8 sm:px-8`}>
                    <div className="space-y-4">
                        <Skeleton height={18} width={116} borderRadius={999} />
                        <Skeleton height={42} width="50%" borderRadius={10} />
                        <Skeleton height={18} width="30%" borderRadius={999} />
                    </div>
                </section>
                ...
                <section className="grid grid-cols-1 gap-6 xl:grid-cols-[minmax(0,1.06fr)_minmax(0,0.94fr)]">
                    <section className={`${panelClass} p-4 sm:p-5`}>
                        <div className={`${surfaceClass} overflow-hidden`}>
                            <div className="border-b border-[#2b2b40] px-4 py-4">
                            ...
                            <div className="space-y-4 border-t border-[#2b2b40] px-4 py-4">
                                <Skeleton height={20} width="40%" borderRadius={999} />
                    ...
                    <aside className="space-y-4">
                        <div className="px-1 pt-1">
                            <Skeleton height={18} width="72%" borderRadius={999} />
                            <div className="mt-3 flex flex-col gap-2 sm:flex-row">
                                <Skeleton height={48} containerClassName="flex-1" borderRadius={10} />
                                <Skeleton height={48} containerClassName="flex-1" borderRadius={10} />
                                <Skeleton height={48} containerClassName="flex-1" borderRadius={10} />
                            </div>
                        </div>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1 space-y-2">
                                                <div className="flex items-center justify-between gap-3">
                                                    ...
                                                    <Skeleton height={12} width={70} borderRadius={999} />
                                                </div>
...
const ExternalReviewPage = () => {
    ...
    if (loading) {
        return <ExternalReviewLoadingSkeleton />;
    }
