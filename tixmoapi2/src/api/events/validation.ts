...
const googleAnalyticsMeasurementIdSchema = z
  .string()
  .trim()
  .max(64, 'Google Analytics ID must be 64 characters or less')
  .regex(/^[A-Za-z0-9_-]*$/, 'Google Analytics ID can only contain letters, numbers, hyphens, and underscores')
  .optional();
...
export const createEventSchema = z.object({
  body: z.object({
    ...
    googleAnalyticsMeasurementId: googleAnalyticsMeasurementIdSchema,
